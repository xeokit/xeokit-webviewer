 ...
 * # Usage
 *
 *  In the example below, we'll create a {@link locale!LocaleService | LocaleService} instance, configured with some English, Māori and French
 ...
 *
 *  For example, if  the {@link locale!LocaleService | LocaleService}'s locale is set to "fr", then the path "NavCube.back" will drill down
 ...
 *  ````
 *
 *  We can also get an event from the {@link locale!LocaleService | LocaleService} whenever we switch locales or load messages, which is useful
