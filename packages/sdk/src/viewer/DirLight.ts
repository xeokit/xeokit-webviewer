...
/**
 * A directional light source within a {@link viewer!View}.
 *
 * ## Summary
 *
 ...
 * World coordinate system, and will appear to move as the {@link viewer!Camera | Camera}  moves. When in View-space, {@link DirLight.dir} is
...
class DirLight extends Component {
    ...
    /**
     ID of this DirLight, unique within the {@link viewer!View}.
     */
