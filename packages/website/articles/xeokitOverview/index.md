<!-- 
  xeokit SDK Documentation - Refactored for readability.
  Comments added where necessary to explain sections and structure.
-->

<!-- Table of Contents generated with BitDownTOC -->
...
- [**Articles**](../../articles/index.html) – Guides for effective SDK use.
...
<!-- 7.1. Example: View a .BIM model and hide all IfcSpaces -->
