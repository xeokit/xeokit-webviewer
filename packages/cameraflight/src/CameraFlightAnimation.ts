...
import {Camera, scheduler, View} from "@xeokit/viewer";
...
/**
 * Animates a {@link @xeokit/viewer!View | View's} {@link @xeokit/viewer!Camera | Camera} to look at specified objects, boundaries or locations.
 *
 * ## Summary
 *
 * * Controls a {@link @xeokit/viewer!Camera | Camera}
 * * Navigates the Camera to look at a {@link @xeokit/viewer!Viewer | Viewer} or boundary
...
class CameraFlightAnimation extends Component {
     ...
     *
     * @param cfg.view The {@link @xeokit/viewer!View | View} whose {@link @xeokit/viewer!Camera | Camera} we'll animate.
     * @param cfg.duration Animation duration in seconds when using {@link @xeokit/cameraflight!CameraFlightAnimation.flyTo | CameraFlightAnimation.flyTo}.
     */
    ...
    /**
     * Flies the {@link @xeokit/viewer!Camera | Camera}  to a target.
     *
     *  * When the target is a boundary, the {@link @xeokit/viewer!Camera | Camera}  will fly towards the target and stop when the target fills most of the canvas.
     *  * When the target is an explicit {@link @xeokit/viewer!Camera | Camera}  position, given as ````eye````, ````look```` and ````up````, then CameraFlightAnimation will interpolate the {@link @xeokit/viewer!Camera | Camera}  to that target and stop there.
     *
     ...
     * an AABB. Defaults to the {@link @xeokit/scene!Scene | Scene}, which causes the {@link @xeokit/viewer!Camera | Camera}  to fit the Scene in view.
     ...
     * @param [params.projection] Projection type to transition into as we fly. Can be any of the values of {@link @xeokit/viewer!Camera.projectionType | Camera.projectionType | Camera.projectionType}.
     * @param [params.fit=true] Whether to fit the target to the view volume. Overrides {@link @xeokit/viewer!CameraFlightAnimation.fit | CameraFlightAnimation.fit}.
     * @param [params.fitFOV] How much of field-of-view, in degrees, that a target {@link @xeokit/viewer!ViewObject | ViewObject} or its AABB should
     * fill the canvas on arrival. Overrides {@link @xeokit/viewer!CameraFlightAnimation.fitFOV | CameraFlightAnimation.fitFOV}.
     * @param [params.duration] Flight duration in seconds.  Overrides {@link @xeokit/viewer!CameraFlightAnimation.duration | CameraFlightAnimation.duration}.
     * @param [params.orthoScale] Animate the Camera's orthographic scale to this target value. See {@link @xeokit/viewer!OrthoProjection.scale | OrthoProjection.scale}.
    ...
    /**
     * Jumps the {@link @xeokit/viewer!Camera | Camera}  to the given target.
     *
     * * When the target is a boundary, this CameraFlightAnimation will position the {@link @xeokit/viewer!Camera | Camera}  at where the target fills most of the canvas.
     * * When the target is an explicit {@link @xeokit/viewer!Camera | Camera}  position, given as ````eye````, ````look```` and ````up```` vectors, then this CameraFlightAnimation will jump the {@link @xeokit/viewer!Camera | Camera}  to that target.
     *
     ...
     * @param [params.look]  Position to fly the look position to.
     * @param [params.up] Position to fly the up vector to.
     * @param [params.projection] Projection type to transition into. Can be any of the values of {@link @xeokit/viewer!Camera.projectionType | Camera.projectionType}.
     * @param [params.fitFOV] How much of field-of-view, in degrees, that a target {@link @xeokit/viewer!Viewer | Viewer} or its AABB should fill the canvas on arrival. Overrides {@link CameraFlightAnimation.fitFOV}.
     * @param [params.fit] Whether to fit the target to the view volume. Overrides {@link @xeokit/viewer!CameraFlightAnimation.fit | CameraFlightAnimation.fit}.
     */
    jumpTo(params: any) {
        this.#jumpTo(params);
    }
    ...
    /**
     * When flying to a {@link @xeokit/scene!SceneModel | SceneModel}, {@link @xeokit/viewer!ViewObject | ViewObject} or boundary, indicates if the CameraFlightAnimation always adjusts
    ...
    /**
     * Sets how much of the perspective field-of-view, in degrees, that a target {@link @xeokit/viewer!ViewObject | ViewObject} should
    ...
    /**
     * Gets how much of the perspective field-of-view, in degrees, that a target {@link @xeokit/viewer!ViewObject | ViewObject} should
     * fill the canvas when calling {@link CameraFlightAnimation.flyTo | CameraFlightAnimation.flyTo} or {@link CameraFlightAnimation.jumpTo | CameraFlightAnimation.jumpTo}.
     *
     * Default value is ````45````.
     */
    ...
    /**
     * Indicates if this CameraFlightAnimation will orient the {@link @xeokit/viewer!Camera | Camera}
