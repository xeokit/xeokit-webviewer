 ...
 *
 * * **Pluggable Renderer** - A Viewer has a pluggable {@link @xeokit/viewer!Renderer | Renderer} strategy that adapts the Viewer to use different
 * browser graphics APIs. In this documentation, we'll use a {@link @xeokit/webglrenderer!WebGLRenderer | WebGLRenderer}, which adapts the Viewer to use
 * WebGL for rendering.
 *
 * * **Scene Models** - A Viewer has a {@link @xeokit/scene!Scene | Scene} which holds model geometry and materials. A Scene is a container of
 * {@link @xeokit/scene!SceneModel | SceneModels}, {@link @xeokit/scene!SceneObject | SceneObjects}, {@link @xeokit/scene!SceneMesh | SceneMeshes}
 * and {@link @xeokit/scene!SceneGeometry | SceneGeometries}. It is a data structure that can be built programmatically, as well as loaded and saved
 ...
 *
 * * **Multiple Views** - A Viewer can have multiple {@link @xeokit/viewer!View | Views}, each providing an independent view of the Scene in
 ...
 *
 * * **View Layers** - Each View can organize objects in {@link @xeokit/viewer!ViewLayer | ViewLayers}. These allow us to partition our
 ...
 *
 * * **Data Models** - A Viewer can optionally integrate with semantic {@link @xeokit/data!Data | Data}. The Data is an
 ...
 * for {@link @xeokit/data!DataModel | DataModels}, {@link @xeokit/data!DataObject | DataObjects}, {@link @xeokit/data!PropertySet | PropertySets}
 * and {@link @xeokit/data!Relationship | Relationships}. Typically, when we want to attach semantic data to a
 * {@link @xeokit/scene!SceneModel | SceneModel}, we would shadow it with a DataModel that has the same ID. For each of the DataModel's SceneObjects that
 ...
 * ## Create a Scene
 *
 * Create a {@link @xeokit/scene!Scene | Scene} to hold our model geometry.
 *
 ...
 *
 * Our Viewer gets a {@link @xeokit/webglrenderer!WebGLRenderer | WebGLRenderer}, which adapts it to use the browser's WebGL graphics API.
 ...
 * ## Create a View
 *
 * A Viewer draws its output to one or more {@link @xeokit/viewer!View | Views}. Each View is an independent and interactive view of the Scene,
 * with its own canvas, {@link @xeokit/viewer!Camera | Camera}, object visual states etc.
 *
 * Within our Viewer, we'll create a {@link @xeokit/viewer!View | View} and arrange its Camera:
 *
 ...
 * ## Add a CameraControl
 *
 * Add a {@link @xeokit/cameracontrol!CameraControl | CameraControl} to the View, to control the View's Camera with mouse and touch input:
 *
 ...
 * ## Create a SceneModel
 *
 * Our {@link @xeokit/scene!Scene | Scene } is a container for model geometry and materials.
 *
 * Within the Scene, we'll create a {@link @xeokit/scene!SceneModel | SceneModel} that contains a couple
 * of textured {@link @xeokit/scene!SceneModel | SceneObjects}. As soon as we've called {@link @xeokit/scene!SceneModel.build | SceneModel.build}, two
 ...
 * ## Slicing Objects
 *
 * Each View can have an unlimited number of interactive {@link @xeokit/viewer!SectionPlane | SectionPlanes}, with which we can use to slice open objects
